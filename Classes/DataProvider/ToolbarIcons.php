...
class ToolbarIcons
{
    private const ICONS = [
        ...
        'MathType' => 'rte_MathType',
        'ChemType' => 'rte_ChemType',
        'restrictedEditing' => 'rte_restrictedEditing',
        'restrictedEditingException' => 'rte_restrictedEditingException',
        'menuBar:restrictedEditing' => 'rte_restrictedEditing',
        'menuBar:restrictedEditingException' => 'rte_restrictedEditingException',
