...
namespace T3Planet\RteCkeditorPack\Database;
...
class RteImagesDbHook
{
    ...
    public function __construct(
        ...
        $this->fetchExternalImages = (bool)$extensionConfiguration
            ->get('rte_ckeditor_pack', 'fetchExternalImages');
    ...
    public function processDatamap_postProcessFieldArray(
        ...
        foreach ($fieldArray as $field => $fieldValue) {
            ...
            $tcaFieldConf = $this->resolveFieldConfigurationAndRespectColumnsOverrides($dataHandler, $table, (string)$field);
